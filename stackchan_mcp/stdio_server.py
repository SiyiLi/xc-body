            ...
            return [
                TextContent(
                    ...
                    text=json.dumps(
                        {
                            "error": (
                                "behavior_id must contain 1 to 128 "
                                "characters"
                            )
                        }
                    ),
        ...
        return [
            ...
            Tool(
                ...
                description=(
                    ...
                    "battery level, speaker volume, screen brightness, "
                    "network status, etc."
                ),
                inputSchema={
                    "type": "object",
            ...
            Tool(
                ...
                description=(
                    ...
                    "The device captures an image and returns an AI-generated "
                    "description."
                ),
                inputSchema={
                    "type": "object",
            ...
            Tool(
                ...
                description=(
                    "Get the robot's current head angles: yaw and pitch in "
                    "degrees."
                ),
                inputSchema={
                    "type": "object",
            ...
            Tool(
                name="gpio_test",
                description=(
                    "Test GPIO6 pin by toggling HIGH/LOW 5 times. Check if "
                    "servo reacts."
                ),
            ...
            Tool(
                name="set_all_leds",
                description=(
                    "Set all 12 RGB LEDs on the StackChan base to the same "
