...
`xc_body_stackchan`. The current firmware version is `0.1.8`, and the app image
...
validation reboot. The robot now runs `0.1.7`; the last fully recorded image
