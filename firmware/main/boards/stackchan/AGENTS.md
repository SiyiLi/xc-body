...
## 4. Servo implementation license

The board uses the MIT-licensed `firmware/components/feetech_scs` driver.
The legacy GPL SCServo fallback is not part of this source tree.
...
| `smooth_ui_toolkit` component missing | Incomplete source checkout | Restore `firmware/components/smooth_ui_toolkit` |
